...
public class MainActivity extends AppCompatActivity implements OnDatabaseCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabs.addTab(tabs.newTab().setText("VIEW"));
    ...
    public void insert(String name, String author, String contents, String url) {
        database.insertRecord(name, author, contents, url);
    ...
    public void delete(String name, String author) {
        database.deleteRecord(name, author);
        Toast.makeText(getApplicationContext(), "책 정보를 삭제했습니다.", Toast.LENGTH_LONG).show();
    }
}
